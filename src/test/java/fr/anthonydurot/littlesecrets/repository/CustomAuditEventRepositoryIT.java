...
import fr.anthonydurot.littlesecrets.config.audit.AuditEventConverter;
import fr.anthonydurot.littlesecrets.domain.PersistentAuditEvent;
...
import static fr.anthonydurot.littlesecrets.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
