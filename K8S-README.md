...
```
$ kubectl get svc littlesecrets -n littlesecrets
```
...
```
$ kubectl scale deployment <app-name> --replicas <replica-count> -n littlesecrets
```
...
```
$ kubectl set image deployment/<app-name>-app <app-name>=<new-image>  -n littlesecrets
```
